...
#define EXT_DECLARE_MODULE_GLOBALS EXT_DECLARE_MODULE_GLOBALS_NX(EXT_NAME)
...
#define EXT_HSHUTDOWN EXT_HSHUTDOWN_NX(EXT_NAME)
...
#define EXT_CLASS_SHUTDOWN(class) EXT_CLASS_SHUTDOWN_NX(EXT_NAME, class)
#define EXT_CLASS_SHUTDOWN_FUNCTION(class) EXT_CLASS_SHUTDOWN_FUNCTION_NX(EXT_NAME, class)
...
#define EXT_CLASS_CESHUTDOWN(class) EXT_CLASS_CESHUTDOWN_NX(EXT_NAME, class)
#define EXT_CLASS_CESHUTDOWN_FUNCTION(class) EXT_CLASS_CESHUTDOWN_FUNCTION_NX(EXT_NAME, class)
...
#define EXT_CLASS_INIT_HANDLERS_CUSTOM_STRUCT(class) EXT_CLASS_INIT_HANDLERS_CUSTOM_STRUCT_NX(EXT_NAME, class)
