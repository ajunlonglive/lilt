...
#   define SHUTDOWN EXT_CLASS_SHUTDOWN(CLASS)
#   define SHUTDOWN_FUNCTION EXT_CLASS_SHUTDOWN_FUNCTION(CLASS)
#   ifdef CLASS_NAME
...
#   define CESHUTDOWN EXT_CLASS_CESHUTDOWN(CLASS)
#   define CESHUTDOWN_FUNCTION EXT_CLASS_CESHUTDOWN_FUNCTION(CLASS)
